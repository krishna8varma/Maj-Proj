...
def response_to_json(text):
    ...
    cleaned_text = text.replace("`", "").replace("\n", "").replace("'", '"').replace('"s',"'s").strip()   #or text=text.replace("`","")  text=text.replace("\n","")  text=text.replace(" ","")
...
def get_hotels(destination,type_of_trip):
  ...
  "input: I am a tourist and want to plan my itinerary to nagpur. can you help me find some budget-friendly (around 1000-3000rs) and some luxurious hotels to stay over? provide the details of 15 hotels. My type of trip is family. Also include 2 famous amenities tags for each hotel. price range should be for per night. provide real hotels name which are in nagpur only.",
  ...
  f"input: I am a tourist and want to plan my itinerary to {destination}. can you help me find some budget-friendly (around 1000-3000rs) and some luxurious hotels to stay over? provide the details of 15 hotels. My type of trip is {type_of_trip}. Also include 2 famous amenities tags for each hotel. price range should be for per night. provide real hotels name which are in {destination} only.",
  "output: ",
]
    response=model.generate_content(prompt_parts)
    res1=response.text
    ...
    if hotel_list is None:
       return []
    #adding hotels link and photos
    images=photos.scrapi_photo(f'Hotels in {destination}')
    for i in hotel_list:
        i['hotelLink']=hotel.getHotelLink(i['hotel_name'],destination)
        i['hotelImage']=random.choice(images)
...
def get_food(destination): 
    ...
    if fc is None:
        return []
    img_fc=photos.get_photo(f"Food Restaurants in {destination}")
    for i in fc:
        i['restaurantLink']=hotel.getHotelLink(i['Restaurant Name'],destination)
...
def planned_trip(destination,duration,type_of_trip,activities):
    ...
    prompt_parts = [
    "input: I am a tourist and want to plan a trip to manali. My type of trip is friends and I would like to enjoy the following activities:['heritage site', 'amusement park', 'hiking', 'clubbing', 'bike ride', 'camping', 'trekking', 'waterfall hike',' photography']. provide me the budget range for the trip provided. output in dictionary format.",
    "output: {\"Day 1\": {\"Budget\": [2000,4200],\"Morning\": {\"Place_Name\": \"Hadimba Temple\",\"Place_location\": [32.24228, 77.187366],\"Opening Hours\": [\"08:00\", \"17:00\"],\"Rating\": 4.7,\"Activity Type\": [\"Photography\", \"Heritage\"]},\"Afternoon\": {\"Place_Name\": \"Himalayan Adventures Park\",\"Place_location\": [32.205276, 77.169732],\"Opening Hours\": [\"09:00\", \"17:00\"],\"Rating\": 4.2,\"Activity Type\": [\"Amusement Park\", \"Games\"]},\"Evening\": {\"Place_Name\": \"Johnson’s Cafe\",\"Place_location\": [32.267461, 77.181867],\"Opening Hours\": [\"24 hours\"],\"Rating\": 4.6,\"Activity Type\": [\"Clubbing\", \"Party\"]}}, \"Day 2\": {\"Budget\": [1500,3000],\"Morning\": {\"Place_Name\": \"Solang Valley\", \"Place_location\": [32.315899, 77.157184],\"Opening Hours\": [\"08:00\", \"17:00\"],\"Rating\": 4.7,\"Activity Type\": [\"Paragliding\", \"Zorbing\"]}, \"Afternoon\": {\"Place_Name\": \"Rohtang Pass\",\"Place_location\": [32.372844, 77.244645],\"Opening Hours\": [\"08:00\", \"17:00\"],\"Rating\": 4.5,\"Activity Type\": [\"Photography\", \"Snow Activities\"]},\"Evening\": {\"Place_Name\": \"Beas River\",\"Place_location\": [32.245843, 77.183274],\"Opening Hours\": [\"24 hours\"],\"Rating\": 4.6,\"Activity Type\": [\"Camping\", \"Bonfire\"]}},\"Day 3\": {\"Budget\": [500,1400],\"Morning\": {\"Place_Name\": \"Hidimba Devi Temple\",\"Place_location\": [32.236548, 77.174717],\"Opening Hours\": [\"08:00\", \"17:00\"],\"Rating\": 4.7,\"Activity Type\": [\"Photography\", \"Heritage\"]},\"Afternoon\": {\"Place_Name\": \"Himalayan Adventures Park\",\"Place_location\": [32.205276, 77.169732],\"Opening Hours\": [\"09:00\", \"17:00\"],\"Rating\": 4.2,\"Activity Type\": [\"Amusement Park\", \"Games\"]},\"Evening\": {\"Place_Name\": \"Manu Temple\",\"Place_location\": [32.239086, 77.180059],\"Opening Hours\": [\"08:00\", \"17:00\"],\"Rating\": 4.6,\"Activity Type\": [\"Historical\", \"Photography\"]}},\"Day 4\": {\"Budget\": [1500,3200],\"Morning\": {\"Place_Name\": \"Jogini Waterfalls\",\"Place_location\": [32.22911, 77.166123],\"Opening Hours\": [\"24 hours\"],\"Rating\": 4.7,\"Activity Type\": [\"Waterfall Hike\", \"Photography\"]},\"Afternoon\": {\"Place_Name\": \"Bhrigu Lake\",\"Place_location\": [32.178975, 77.652943],\"Opening Hours\": [\"24 hours\"],\"Rating\": 4.5,\"Activity Type\": [\"Trekking\", \"Photography\"]},\"Evening\": {\"Place_Name\": \"Camp Purple\",\"Place_location\": [32.256245, 77.193496],\"Opening Hours\": [\"24 hours\"],\"Rating\": 4.6,\"Activity Type\": [\"Camping\", \"Bonfire\"]}},\"Day 5\": {\"Budget\": [5000,7000],\"Morning\": {\"Place_Name\": \"Parvati River\",\"Place_location\": [32.106262, 77.177348],\"Opening Hours\": [\"24 hours\"],\"Rating\": 4.7,\"Activity Type\": [\"River Rafting\", \"Camping\"]}, \"Afternoon\": {\"Place_Name\": \"Solang Valley\",\"Place_location\": [32.315899, 77.157184],\"Opening Hours\": [\"08:00\", \"17:00\"],\"Rating\": 4.7,\"Activity Type\": [\"Biking\", \"Paragliding\"]}, \"Evening\": {\"Place_Name\": \"The Johnson's Bar & Restaurant\",\"Place_location\": [32.24575, 77.183233],\"Opening Hours\": [\"24 hours\"],\"Rating\": 4.6,\"Activity Type\": [\"Food\", \"Drinks\"]}}}",
